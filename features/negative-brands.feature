...
Feature: Negative sizing flow across brands (env: prod)
  ...
  Scenario Outline: Continue button stays disabled when all measurements are invalid
    ...
    Examples:
      | url |
      | https://drawer.kleep.ai/?domain=www.bonpoint.com&product_id=PF7839-00-001&lang=en&countryCode=GB&mock=true |
      | https://drawer.kleep.ai/?domain=www.givenchy.com&product_id=PF7839-00-001&lang=en&countryCode=GB&mock=true |
      | https://drawer.kleep.ai/?domain=www.kenzo.com&product_id=PF7839-00-001&lang=en&countryCode=GB&mock=true |
      | https://drawer.kleep.ai/?domain=fr.simone-perele.com&product_id=PF7839-00-001&lang=en&countryCode=GB&mock=true |
